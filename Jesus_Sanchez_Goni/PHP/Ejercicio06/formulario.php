...
<body>
    <form action="resultado.php" enctype="multipart/form-data" method="POST">
        ...
        <p><input type="checkbox" name="opcion" value="123">Opcion</p>
        <p>
            <input type="radio" name="datos" value="66" checked>Dato 1
            <input type="radio" name="datos" value="77" >Dato 2
        </p>    
            <select name="seleccion[]" id="2"multiple="multiple">
